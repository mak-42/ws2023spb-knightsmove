...
1.1. В своём клоне репозитория зайти на закладку **Actions** и активировать запуск процессов, нажав кнопку **I understand my workflows, go ahead and enable them.**
